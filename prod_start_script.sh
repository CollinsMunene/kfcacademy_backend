...
# sudo cp  -r /root/FPCAcademy_backend/staticfiles/* /var/www/fpc/staticfiles/
# sudo chown -R www-data:www-data /var/www/fpc/staticfiles
# sudo chmod -R 755 /var/www/fpc/staticfiles
